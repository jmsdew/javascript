...
console.log( num.__proto__ === Number.prototype ); // true  proto = 부모를 참조하는 것

// num은 Object.prototype을 상속받았는가?
console.log( num.__proto__.__proto__ === Object.prototype ); // true 부모의 부모

// 체인 맨 위엔 null이 있다.
console.log( num.__proto__.__proto__.__proto__ ); // null 오브젝트의 부모는 없음
...
// 내장 프로토타입은 수정 가능하다.
String.prototype.hello = function() {   // 문자열은 이제 다 hello를 호출할 수 있음
